...
<br/>Completely responsive and beautiful web UI built with sync, utils and env
...
- You can also change the code to add icons or request to add in the Discussions <a href="https://github.com/user/templatekit/discussions">HERE</a>
